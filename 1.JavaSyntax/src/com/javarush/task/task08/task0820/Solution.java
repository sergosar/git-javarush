...
public class Solution {
    ...
    public static Set<Dog> createDogs() {
        HashSet<Dog> result = new HashSet<>(); // 4
        for (int i = 0 ; i < 3; i++  ) result.add(new Dog());//напишите тут ваш код
        return result;
    }

    public static Set<Object> join(Set<Cat> cats, Set<Dog> dogs) {
        HashSet<Object> result = new HashSet<>();
        result.addAll(cats); result.addAll(dogs);
        return result;
    }
    ...
    public static void printPets(Set<Object> pets) {
        for (Object o : pets) System.out.println(o);//напишите тут ваш код
    }
