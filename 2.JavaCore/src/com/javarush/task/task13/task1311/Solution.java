...
4. Программа должна выводить на экран «Я переводчик с английского» путем вызова метода translate у
...
5. Метод main должен выводить на экран строку "Я переводчик с английского" путем вызова метода translate у
 объекта типа EnglishTranslator.
*/
